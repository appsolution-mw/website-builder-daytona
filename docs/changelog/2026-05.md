...
### T-20260505-010 - Durable agent queue schema added

- Added workspace tenancy, project queue state, agent run, run attempt, and run
  event Prisma schema plus the durable queue migration and smoke test.
- Affected files: `prisma/schema.prisma`,
  `prisma/migrations/20260505190000_add_durable_agent_queue/migration.sql`,
  `lib/agent-runs/__tests__/schema-smoke.test.ts`,
  `docs/tasks/done/2026/05/T-20260505-010.md`.
